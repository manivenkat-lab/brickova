...
export const INDIAN_CITIES = [
  "Mumbai", "Delhi", "Bangalore", "Hyderabad", "Chennai", "Pune", "Gurgaon", "Kolkata", "Ahmedabad", "Jaipur", "Lucknow", "Chandigarh"
].sort();

export const CURRENCY_SYMBOLS = { INR: '₹', USD: '$', AED: 'د.إ', EUR: '€' };

export const PRICING_PLANS = {
  [MembershipTier.FREE]: { name: 'Free Plan', price: 0 },
  [MembershipTier.BASIC]: { name: 'Basic Agent', price: 1999 },
  [MembershipTier.PRO]: { name: 'Pro Agent', price: 2999 },
  [MembershipTier.AGENCY]: { name: 'Agency Plan', price: 5999 },
};
