  ...
  return (
    <div className="bg-beige-50 rounded-2xl border-2 border-beige-200 p-6 md:p-8 space-y-6 md:space-y-8 shadow-inner">
      <div className="flex items-center gap-4 border-b border-beige-200 pb-4 md:pb-5">
        ...
        <div>
          <h3 className="text-[10px] md:text-[11px] font-bold text-navy uppercase tracking-wider">Institutional Finance</h3>
          <p className="text-[7px] md:text-[8px] font-bold text-navy-muted uppercase tracking-widest mt-0.5">Investment Schema</p>
        </div>
      </div>
      ...
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-end text-[9px] md:text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="space-y-2.5">
             ...
             />
             <div className="flex justify-between text-[8px] md:text-[9px] font-bold text-gold tracking-tight">
      ...
      <div className="space-y-4 pt-4">
        <div className="bg-white p-6 md:p-8 rounded-xl border border-gold/20 space-y-2 shadow-elevated text-center relative overflow-hidden group">
          ...
          <span className="text-[9px] md:text-[10px] font-bold text-navy-muted uppercase tracking-widest block opacity-60">Monthly Outlay</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/80 p-4 rounded-lg border border-beige-200 text-center shadow-soft">
            <span className="text-[7px] md:text-[8px] font-bold text-navy-muted uppercase tracking-wider block mb-1 opacity-50">Total Interest</span>
          ...
          <div className="bg-white/80 p-4 rounded-lg border border-beige-200 text-center shadow-soft">
            <span className="text-[7px] md:text-[8px] font-bold text-navy-muted uppercase tracking-wider block mb-1 opacity-50">Protocol Total</span>
      ...
      <p className="text-[7px] md:text-[8px] text-navy-muted font-bold tracking-wider text-center opacity-40 uppercase leading-relaxed px-4">
